...
gui.handles.title_temperature = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [x_coord 0.85 0.07 0.025],...
    'String', 'Temperature :',...
    'HorizontalAlignment', 'left',...
    'Visible', 'on');

gui.handles.value_temperature = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'Position', [0.08 0.85 0.03 0.025],...
    'String', '20',...
    'Visible', 'on');

gui.handles.unit_temperature = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [0.11 0.85 0.02 0.025],...
    'String', '°C',...
    'HorizontalAlignment', 'center',...
    'Visible', 'on');
...
gui.handles.title_mindepth_prop_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [x_coord 0.815 0.07 0.025],...
...
gui.handles.value_mindepth_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'edit',...
    'Position', [0.08 0.815 0.03 0.025],...
    'String', '',...
    'Visible', 'on',...
    'Callback', 'get_and_plot');
...
gui.handles.unit_mindepth_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [0.11 0.815 0.02 0.025],...
    'String', 'nm',...
    'HorizontalAlignment', 'center',...
    'Visible', 'on');
...
gui.handles.title_maxdepth_prop_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [x_coord 0.79 0.07 0.025],...
...
gui.handles.title_num_popin_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [x_coord 0.75 0.15 0.03],...
...
gui.handles.title_crit_param_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'text',...
    'Position', [x_coord 0.68 0.15 0.03],...
...
gui.handles.value_crit_param_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'popup',...
    'Position', [x_coord 0.65 0.15 0.03],...
...
gui.handles.run_calc_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
    'Position', [x_coord 0.56 0.10 0.06],...
