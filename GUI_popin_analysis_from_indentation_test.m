...
function gui_handle = GUI_popin_analysis_from_indentation_test
...
gui.config.version_toolbox = '2.2';
...
gui.handles.MainWindows = figure('Name', strcat(gui.config.name_toolbox, '_Version_', gui.config.version_toolbox),...
    'NumberTitle', 'off',...
...
gui.handles.typedata_GUI = uicontrol('Parent', gui.handles.MainWindows,...
    'Units', 'normalized',...
    'Style', 'text',...
...
%% Number of pop-in
gui.handles.title_num_popin_GUI = uicontrol('Parent', gui.handles.MainWindows,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.value_num_popin_GUI = uicontrol('Parent', gui.handles.MainWindows,...
    'Units', 'normalized',...
    'Style', 'popup',...
...
gui.handles.title_crit_param_GUI = uicontrol('Parent', gui.handles.MainWindows,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.value_crit_param_GUI = uicontrol('Parent', gui.handles.MainWindows,...
    'Units', 'normalized',...
    'Style', 'popup',...
...
gui.handles.run_calc_GUI = uicontrol('Parent', gui.handles.MainWindows,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
